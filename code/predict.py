...
if __name__ == "__main__":
    ...
    for i in range(len(dataset)):
        ...
        # make the prediction
        prediction_l2 = smoothed_classifier.predict_l2(x, args.N, args.alpha, args.batch)
        prediction_l1 = smoothed_classifier.predict_l1(x, args.N, args.alpha, args.batch)
        ...
        print("{}\t{}\t{}\t{}\t{}".format(i, label, final_prediction, correct, time_elapsed), file=f, flush=True)
